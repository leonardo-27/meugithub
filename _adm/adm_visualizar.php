...
<head>
	...
	<title>Administrador - Visualizar Dados Completos</title>
	...
	<body>
		...
		<div class="container theme-showcase" role="main">
			<div class="page-header">
				<h1>Lista de dados completos deste usuário</h1>
			</div>	
				...
				<div class="col-md-12">
					<form>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="nome" class="form-control" id="inputText"  readonly
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="sexo" class="form-control" id="inputSexo" readonly 
								value="<?php echo $row_usuarios['sexo']?>">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="nivel_user_id" id="inputNivelUsuario" class="form-control" readonly 
								value="<?php echo $row_usuarios['nivel_user_id'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="inputSitUsuario">Situação Usuário:</label>
							<div class="col-sm-10">
								<input type="text" name="situacao_usuario_id" id="inputSitUsuario" class="form-control" readonly
								value="<?php echo $row_usuarios['situacao_usuario_id'];?>">
							</div>
						</div>
						<div class="form-group">
