...
<head>
	...
	<title>Administrador - Listar Administradores</title>
...
<body>
		    ...
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item dropdown">
			      ...
			      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
			        ...
			        <a class="dropdown-item" href="#">Listar Administradores<span class="sr-only">(current)</span></a>
			      </div>
			  </li>
		      <li class="nav-item">
  			...
  			<ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
			    <li class="nav-item dropdown">
			      ...
			      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
			        ...
			        <a class="dropdown-item" href="adm_listar_usuarios.php">Listar Usuários</a>
			        <a class="dropdown-item" href="#">Listar Administradores</a>
			        <div class="dropdown-divider"></div>
	...
	<body>
		<?php
			$result_usuarios = "SELECT * FROM usuarios WHERE nivel_user_id = 2";
