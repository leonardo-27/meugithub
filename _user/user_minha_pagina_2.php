...
<head>
	...
	<title>Usuário - Minha Página 2</title>
...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-info">
		  ...
		  <div class="collapse navbar-collapse" id="navbarNavDropdown">
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item">
		        <a class="nav-link" href="user_outro.php">Outro</a>
		      </li>
		      <li class="nav-item">
		      ...
		      <li class="nav-item">
		      	<a class="nav-link" href="#">Minha Página 2<span class="sr-only">(current)</span></a>
		      </li>
		      <li class="nav-item">
  			...
  			<ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
			    <li class="nav-item dropdown">
			      ...
			      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
			        ...
			        <a class="dropdown-item" href="user_outro.php">Outro</a>
			        ...
			        <a class="dropdown-item" href="#">Minha Página 2</a>
			        <div class="dropdown-divider"></div>
	...
	<h1>Página Minha Página 2 Usuário</h1>
